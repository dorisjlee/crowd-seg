...
def runTileMLConstruction(objid,workerErrorfunc,Qjfunc,A_percentile,Niter=10,DEBUG=False,PLOT_LIKELIHOOD=False):
    '''
    Input:
    _____
    ...
    for _i in tqdm(range(Niter)):
        ...
        if _i ==0:
            ...
            qinit = list(np.ones(len(workers))*0.6)
...
if __name__ =="__main__":
    ...
    # Tstar =runTileMLConstruction2(objid,workerErrorfunc="GTLSA",Qjfunc=QjGTLSA,A_percentile=90,Niter=10,DEBUG=True,PLOT_LIKELIHOOD=False)
