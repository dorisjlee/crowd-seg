...
def segment(img):
	...
	if request.args.get("assignmentId") == "ASSIGNMENT_ID_NOT_AVAILABLE":
		...
		resp = make_response(render_template('page.html',name=render_data,filename=filename,ht=384,wd=512,accepted=False))
	else:
		#Our worker accepted the task
		resp = make_response(render_template('page.html',name=render_data,filename=filename,ht=384,wd=512,accepted=True))
